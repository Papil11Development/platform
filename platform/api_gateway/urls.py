...
from api_gateway.api.vLuna.internal_schema import schema as internal_schema_vLuna
...
urlpatterns = [
    ...
    path('internal-api/vLuna/', APIView.as_view(schema=internal_schema_vLuna, graphiql=settings.DEBUG)),
